...
Note:
To be able to read csv file you need to create folder *assets* inside src/androidTest/
Right click on androidTest folder -> New -> Folder -> Assets Folder -> choose correct location
